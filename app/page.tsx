...
const services = [
  {
    icon: Home,
    title: "Verkkosivut",
    text: "Rakennan selkeät ja mobiiliystävälliset sivut pienille yrityksille."
  },
  {
    icon: PenLine,
    title: "Design",
    text: "Rauhallinen ja viimeistelty ulkoasu, joka tukee yrityksesi ilmettä."
  },
  {
    icon: Mail,
    title: "Yhteydenottolomake",
    text: "Helppo tapa ottaa yhteyttä suoraan sivun kautta."
  },
  {
    icon: Search,
    title: "Perus SEO",
    text: "Sivun perustat kuntoon, jotta yrityksesi löytyy helpommin."
  }
];

export default function HomePage() {
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#171615] text-white">
      <div className="relative h-[142vh]">
        <section className="sticky top-0 min-h-screen overflow-hidden">
          ...
          <div className="relative z-10 flex min-h-screen flex-col">
            <header className="mx-auto flex w-full max-w-[1500px] items-center justify-between px-6 py-6 md:px-14 lg:px-20">
            ...
            <div className="mx-auto grid w-full max-w-[1500px] flex-1 items-center gap-10 px-6 pb-12 pt-6 md:grid-cols-2 md:px-14 lg:px-20">
                    ...
                    <div className="grid grid-cols-2 gap-px bg-[#d8c8b5] md:grid-cols-4">
                      {previewServices.map((service) => {
                        ...
                        return (
                          <div
                            key={service.title}
                            className="bg-[#f4ecdf] px-5 py-7 text-center text-[#17120e]"
                          >
      ...
      <section
        id="palvelut"
        className="relative z-20 -mt-[34vh] rounded-t-[2.75rem] border-t border-white/10 bg-[#1d1713] px-6 pb-24 pt-16 text-[#f8efe5] shadow-[0_-35px_90px_rgba(0,0,0,0.42)] md:px-14 md:pt-20 lg:px-20"
      >
        <div className="mx-auto max-w-[1500px]">
          <div className="mb-10 flex flex-col justify-between gap-5 md:flex-row md:items-end">
            <div>
              <p className="mb-3 text-xs font-bold uppercase tracking-[0.18em] text-[#f0a24f]">
                Palvelut
              </p>
              <h2 className="max-w-2xl font-serif text-4xl leading-tight tracking-[-0.04em] md:text-6xl">
                Selkeät ratkaisut pienille yrityksille.
              </h2>
            </div>

            <p className="max-w-md text-base leading-7 text-[#c8b5a4]">
              Keskityn siihen, että sivu näyttää hyvältä, toimii puhelimella ja
              tekee yhteydenotosta asiakkaalle mahdollisimman helppoa.
            </p>
          </div>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {services.map((service) => {
              ...
              return (
                <article
                  key={service.title}
                  className="group rounded-3xl border border-white/10 bg-[#261f1a] p-7 shadow-[0_24px_70px_rgba(0,0,0,0.18)] transition duration-300 hover:-translate-y-1 hover:border-[#f0a24f]/40 hover:bg-[#2d251f]"
                >
                  <div className="mb-8 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#f3981f]/12 text-[#f0a24f] ring-1 ring-[#f3981f]/20 transition group-hover:bg-[#f3981f]/18">
                    <Icon size={25} strokeWidth={1.7} />
                  </div>

                  <h3 className="font-serif text-2xl text-[#fff5e8]">
                    {service.title}
                  </h3>
                  <p className="mt-3 text-sm leading-6 text-[#c8b5a4]">
                    {service.text}
                  </p>
                </article>
              );
